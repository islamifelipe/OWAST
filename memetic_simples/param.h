...
#define PORCENT_RANDOM 70 //--- NAO UTILIZADO NO MOMENTO
#define PORCENT_KCENTRUM 10 //--- NAO UTILIZADO NO MOMENTO
#define PORCENT_KTRIMENT 10 //--- NAO UTILIZADO NO MOMENTO
