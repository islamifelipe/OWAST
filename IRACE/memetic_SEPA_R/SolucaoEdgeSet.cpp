...
class SolucaoEdgeSet : public Solucao {
	...
	SolucaoEdgeSet(int n,TRandomMersenne &r) {
		edges = new int*[numerovertices];
		for (int i=0; i<numerovertices; i++) edges[i] = new int[2];
    ...
    void RandomWalk(bool unionGraph[1000][1000]){
    	uf.clear();
